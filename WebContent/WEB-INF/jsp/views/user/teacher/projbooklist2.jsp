...
<body>
	<div class="lyear-layout-web">
      ...
      <p></p>
          <h4 align="center">基于MVC的高校<br>毕业设计选题系统</h4>
      </div>
          ...
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item nav-item-has-subnav active open">
              ...
              <ul class="nav nav-subnav">
                ...
                <li class="active"> <a href="${pageContext.request.contextPath }/teacher/projBooklist2.action">提交任务书</a> </li>
              </ul>
            </li>
            <li class="nav-item nav-item-has-subnav">
              <a href="javascript:void(0)"><i class="mdi mdi-file-outline"></i> 需求分析管理</a>
              <ul class="nav nav-subnav">
                <li> <a href="${pageContext.request.contextPath }/teacher/projBooklist.action">已审核需求分析</a> </li>
                <li> <a href="${pageContext.request.contextPath }/teacher/projBooklist1.action">待审核需求分析</a> </li>
              </ul>
            </li>
            <li class="nav-item nav-item-has-subnav">
				...
				<nav class="navbar navbar-default">
					<div class="topbar">
						...
						<div class="topbar-left">
							...
							<span class="navbar-page-title"> 提交需求分析 </span>
						</div>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-toolbar clearfix">
								<form id="form_query"
									action="${pageContext.request.contextPath }/teacher/projBooklist2.action"
						...
						<div class="modal-body">
							<form id="selectById_title_form">
										<div class="form-group">
											<label for="message-text" class="control-label">需求分析建议内容：</label>

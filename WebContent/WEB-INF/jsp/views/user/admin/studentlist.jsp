...
<body>
						...
						<div class="card">
							...
							<div class="card-body">
								<button type="button" class="btn btn-label btn-primary" data-toggle="modal" 
		           				...
		           				<button type="button" class="layui-btn" style="background-color: #33cabb" id="upstudent">上传学生信息</button>
	...
	layui.use('upload', function(){
		  ...
		  var uploadInst = upload.render({
		    elem: '#upstudent' //绑定元素
		    ,url: '/Graduation-Design-Management-System/admin/uploadstudent.action' //上传接口
		    ,accept: 'file'
		    ,done: function(res){
				layer.msg('上传成功');

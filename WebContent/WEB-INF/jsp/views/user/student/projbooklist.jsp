						...
						<ul class="nav nav-drawer">
							...
							<li class="nav-item nav-item-has-subnav active open"><a
								href="javascript:void(0)"><i class="mdi mdi-file-outline"></i>
									需求分析管理</a>
								<ul class="nav nav-subnav">
									<li class="active"><a href="${pageContext.request.contextPath }/student/projBooklist.action">需求分析</a></li>
								</ul></li>
								<li class="nav-item nav-item-has-subnav"><a
								href="javascript:void(0)"><i class="mdi mdi-file-outline"></i>
									开题报告管理</a>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-toolbar clearfix">
								<span style="font-size:25px;font-weight:bold"> 请在与老师沟通之后提交需求分析 </span>
								<form id="form_query"
							...
							<c:if test="${i eq 1 && i2 eq 0}">
							    ...
							    <input id="fType" type="text" name="fType" hidden="hidden" value="需求分析">

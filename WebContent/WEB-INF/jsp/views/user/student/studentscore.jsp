						...
						<ul class="nav nav-drawer">
							...
							<li class="nav-item nav-item-has-subnav"><a
								href="javascript:void(0)"><i class="mdi mdi-file-outline"></i>
									需求分析管理</a>
								<ul class="nav nav-subnav">
									<li><a href="${pageContext.request.contextPath }/student/projBooklist.action">需求分析</a></li>
								</ul></li>
								<li class="nav-item nav-item-has-subnav"><a
								href="javascript:void(0)"><i class="mdi mdi-file-outline"></i>
									开题报告管理</a>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title" id="exampleModalLabel">	评阅/答辩评分</h4>
						</div>
						<div class="modal-body">
							...
							<input hidden="hidden" type="text" id="s_Id" name="sId">			
										<div class="form-group">
											...
											<label for="reviewScore" class="control-label">答辩组评分：</label>
											<input readOnly type="text" class="form-control" name="reviewScore" id="reviewScore" />
											<label for="review_Comments" class="control-label">答辩组评语：</label>
											...
											<label for="reviewScore1" class="control-label">评阅组评分：</label>
											...
											<label for="reviewScore2" class="control-label">评阅组评分：</label>
	  ...
	  //评阅教师对论文编辑评语、评分
	    function getReviewBySId(sId) {
	    	$.ajax({
				...
				success : function(review,selectTitle) {

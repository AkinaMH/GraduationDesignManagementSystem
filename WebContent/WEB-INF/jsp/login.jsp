		...
		<div class="lyear-login">
			<div class="login-center">
				...
				<form action="${pageContext.request.contextPath }/login.action" method="post" onsubmit="return check()">
					...
					<div class="form-group has-feedback feedback-left">
						<input type="password" placeholder="请输入密码" class="form-control" id="password" name="password" value="123" />
						<span class="mdi mdi-lock form-control-feedback" aria-hidden="true"></span>
					</div>
					
					<div class="form-group has-feedback feedback-left row">
						<div class="col-xs-12" align="right">
							<select style="width: 150px" class="form-control" id="role"
								name="role" size="1">

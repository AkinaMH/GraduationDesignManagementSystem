...
public class AdminController {
	...
	//上传excel导入教师信息
	@RequestMapping("/admin/upload.action")
    @ResponseBody
    public void upload(MultipartFile file) throws IOException {
        adminService.saveTeacher(file,teacherService,baseDeptService);
    }
	
	//上传excel导入学生信息
	@RequestMapping("/admin/uploadstudent.action")
	@ResponseBody
	public void uploadStudent(MultipartFile file) throws IOException {
	    adminService.saveStudent(file,studentService,baseMajorService);
	}
